...
def positive_assert(first_name):
    ...
    user_response = Ku_test1.post_new_user(user_body)
    ...
    users_table_response = Ku_test1.get_users_table()
...
def negative_assert_symbol(first_name):
    user_body = get_user_body(first_name)
    response = Ku_test1.post_new_user(user_body)
...
def test_create_user_15_letter_in_first_name_get_success_response():
    positive_assert("AaBbCcDdEeFfGgH")

def test_create_user_1_letter_in_first_name_get_error_response():
    negative_assert_symbol("a")

def test_create_user_16_letter_in_first_name_get_error_response():
    negative_assert_symbol("AaBbCcDdEeFfGgHh")
